...
const syncInventoryStockIn = async (zone, date, stockIn, addedBy) => {
  ...
  const payload = {
    ...
    // A real Stock Options save turns a previously scheduled placeholder into
    // a user-managed inventory row.  Without this, the inventory endpoint
    // hides the row as automatic even though its Stock In was changed.
    autoGenerated: false,
    updatedAt: new Date(),
  };
